...
<body>
    ...
    <fieldset class="w-75 mt-5 mx-auto p-4 bg-light rounded shadow">
        <h2 class='mb-3'>Delete request <img class='img-thumbnail rounded-circle' src='pictures/<?php echo $picture ?>' alt="<?php echo $f_name ?>"></h2>
        ...
        <form method="post">
            ...
            <a href="dashboard.php"><button class="btn btn-tertiary" type="button">No, go back!</button></a>
        </form>
    </fieldset>
</body>
</html>